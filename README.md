...
**Version 3.4.0** · [Download the Windows x64 installer](https://github.com/zerr0o/prime-agent-studio/releases/download/v3.4.0/Prime-Agent-Studio_3.4.0_x64-setup.exe) · [Release history](docs/en/changelog.md).
...
**After updating:** the application can keep using the previous server while agents finish. Once they have finished, use **Preferences → Updates → Restart server** in the Windows application to activate 3.4.0. [Update guide](docs/en/desktop.md).
