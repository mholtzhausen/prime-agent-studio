...
**Version 4.1.1** · [Download AppImage or deb](https://github.com/mholtzhausen/prime-agent-studio/releases/latest) · [Release history](docs/en/changelog.md).
...
**After updating:** the application can keep using the previous server while agents finish. Once they have finished, use **Preferences → Updates → Restart server** in the Linux application to activate 4.1.1. [Update guide](docs/en/desktop.md).
