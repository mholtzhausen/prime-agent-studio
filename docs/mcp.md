...
Le test résout son interpréteur via `PRIME_AGENT_KERNEL_PYTHON`, un marqueur de kernel existant, ou `python3` dans le PATH. Le Studio ne prépare pas de kernels uv pour cette probe.
