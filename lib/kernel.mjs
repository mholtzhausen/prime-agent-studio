...
const pythonIn = (venv) => join(venv, 'bin/python');
...
export async function ensureLocalKernel(
  ...
  const job = (async () => {
    ...
    try {
      ...
      if (!uv) throw new Error('uv est introuvable. La préparation Studio du noyau est obsolète ; laissez Prime Agent amorcer son noyau Python.');
